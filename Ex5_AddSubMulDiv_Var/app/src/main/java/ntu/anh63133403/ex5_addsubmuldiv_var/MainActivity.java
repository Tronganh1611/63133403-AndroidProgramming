...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Timdieukhien();
        nutCong.setOnClickListener(Bo_xuliCong);
        nutTru.setOnClickListener(Bo_xuliTru);
        nutNhan.setOnClickListener(Bo_xuliNhan);
        nutChia.setOnClickListener(Bo_xuliChia);
    }
    View.OnClickListener Bo_xuliCong = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            XuliCong(view);
        }
    };
    View.OnClickListener Bo_xuliTru = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            XuliTru(view);
        }
    };
    View.OnClickListener Bo_xuliNhan = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            XuliNhan(view);
        }
    };
    View.OnClickListener Bo_xuliChia = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            XuliChia(view);
        }
